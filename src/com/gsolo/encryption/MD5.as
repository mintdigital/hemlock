package com.gsolo.encryption {	
	public class MD5 {
		...
		public static function hex_md5_raw (string:String):String {
			return rstr2hex (rstr_md5 (string));
		}

		public static function hex_binl_md5 (array:Array, length:int):String {
			return rstr2hex(binl2rstr(binl_md5(array, length)));
		}
