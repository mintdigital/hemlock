package com.mintdigital.hemlock.clients{
    ...
    import com.mintdigital.hemlock.conn.XMPPConnectionLite;
    ...
    public class XMPPClientLite implements IClient{

        private var _connection:XMPPConnectionLite;
        ...
        public function logout():void {
            Logger.debug("XMPPClientLite::logout()");
        ...
        public function configureRoom(roomJID:JID, configOptions:Object = null):void{
            Logger.debug('XMPPClientLite::configureRoom() : roomJID = ' + roomJID);
        ...
        public function sendPresence(toJID:JID, options:Object):void{
            ...
            Logger.debug('XMPPClientLite::sendPresence() : options = ' + HashUtils.toString(options));
        ...
        private function onRoomEventCreate(e:PresenceEvent):void {
            Logger.debug("XMPPClientLite::onRoomEventCreate()");
...
/*            Logger.debug("My nickname before the save: " + _vCard.nickname);
        ...
        private function onStreamStart(event:StreamEvent) : void {
            Logger.debug('XMPPClientLite::onStreamStart() : loggedIn = ' + _loggedIn);
        ...
        public function handleBindResponse(packet:IQ) : void {
            Logger.debug("XMPPClientLite::handleBindResponse()");
        ...
        public function handleRoomDisco(packet:IQ):void {
            Logger.debug("XMPPClientLite::handleRoomDisco()");
        ...
        public function handleUserDisco(packet:IQ):void {
            Logger.debug("XMPPClientLite::handleUserDisco()");
        ...
        public function handleItemUpdate(packet:IQ):void {
            Logger.debug("XMPPClientLite::handleItemUpdate()");
        ...
        public function handleAffiliationUpdate(packet:IQ):void {
            Logger.debug("XMPPClientLite::handleAffiliationUpdate()");
        ...
        public function handleRoleUpdate(packet:IQ):void {
            Logger.debug("XMPPClientLite::handleRoleUpdate()");
        ...
        private function dispatchRoomLeaveEvent(presence:Presence, roomJID:JID):void {
            Logger.debug("XMPPClientLite::dispatchRoomLeaveNotification()");
        ...
        private function authenticate(mechanism:String):void{
            ...
            Logger.debug('XMPPClientLite::authenticate() : mechanism = ' + mechanism);
        ...
        private function register() : void {
            Logger.debug("XMPPClientLite::register()");
